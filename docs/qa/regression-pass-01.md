...
- Reproduction steps:
  1. Open [tenant-admin page](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/app/tenant-admin/page.tsx).
  2. Follow the tenant-admin route chain in [middleware](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/middleware.ts).
  3. Inspect the rendered shell in [tenant-admin-shell.tsx](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/components/tenant-admin/tenant-admin-shell.tsx).
  4. Inspect billing-enrollment administration redirects such as [administration/page.tsx](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/app/dashboard/billing-enrollment/administration/page.tsx).
...
- Reproduction steps:
  ...
  3. Inspect [admin-route-aliases.ts](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/lib/admin-route-aliases.ts).
  4. Inspect legacy redirect pages such as [platform-admin/users/page.tsx](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/app/platform-admin/users/page.tsx) and [platform/metrics/page.tsx](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/app/platform/metrics/page.tsx).
...
- Reproduction steps:
  1. Inspect [broker/page.tsx](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/app/broker/page.tsx).
  2. Note that it loads broker cases, commissions, renewals, quotes, and book-of-business groups before first render.
  3. Inspect [BrokerDashboardWorkspaceSection.tsx](/Users/jfrank/Projects/Modular%20portal/apps/portal-web/components/billing-enrollment/BrokerDashboardWorkspaceSection.tsx), which receives those datasets after the page has already materialized them.
...
- Reproduction steps:
  1. Inspect [admin-platform-sessions.ts](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/lib/admin-platform-sessions.ts).
  2. Note that `PERSONA_SESSION_STORAGE_KEY` and `ACTIVE_PERSONA_SESSION_STORAGE_KEY` are persisted in `window.localStorage`.
  3. Inspect [admin-platform-session-manager.tsx](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/components/admin-platform/admin-platform-session-manager.tsx), which loads those values on mount.
...
- Reproduction steps:
  1. Open [workspace page route](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/app/admin/workspace/%5BsessionId%5D/page.tsx).
  2. Observe that `tenantId`, `personaType`, and `userId` come directly from `searchParams`.
  3. Inspect [admin-persona-workspace.tsx](/Users/jfrank/Projects/Modular%20portal/apps/admin-console/components/admin-platform/admin-persona-workspace.tsx), which renders those values without validating them against an authoritative session record.
