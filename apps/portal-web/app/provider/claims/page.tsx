import { ProviderClaimsBillingWorkspace } from '../../../components/provider/operations/provider-workspaces';
...
export default async function ProviderClaimsRoutePage() {
  ...
  return <ProviderClaimsBillingWorkspace clinicName={clinicName} dashboard={dashboard} />;
}
